...
> ```
> si `fatal error: '<file>.h' file not found` -> remplacer la ligne produisant l'erreur : par la ligne correspondant à la file :
> ```
...
- installer `sudo apt install qt5-qmake` et `libftdi-dev`
