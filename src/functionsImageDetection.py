...
def show_circles_on_img(image_array):
    ...
    detected_circles = cv2.HoughCircles(gimgblur,cv2.HOUGH_GRADIENT,dp =3,minDist=20, param1=60, param2=85, minRadius=20, maxRadius=50)
...
def return_circles_on_img(image_array):
